...
# The spawn-defaults and per-verb profile blocks live in fno.config.spawn_profile;
# this module is over the file budget and may only shrink, and their removal is
# the banked shrink that pays for this file's next change.
from fno.config.spawn_profile import SpawnDefaultsBlock, SpawnProfileBlock  # noqa: E402
