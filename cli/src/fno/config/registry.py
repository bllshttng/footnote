...
FIELD_META: dict[str, Meta] = {
    ...
    "agents.max_load_per_cpu": Meta("advanced", "DEPRECATED and ignored since 2026-09-09 (x-7783): admission decides on the fleet's CPU share (agents.max_fleet_cpu_share) on every spawn, never on a load trigger - the 1-minute load moved 101 points in three minutes with no change in real work. The key parses for one release and prints one deprecation line when set; delete it.", default_source="default"),
