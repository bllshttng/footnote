...
FIELD_META: dict[str, Meta] = {
    ...
    "graph.read_source": Meta("advanced", "Graph read backend: json keeps the export authoritative; sqlite reads the shadow row store (default json).", default_source="default"),
