...
class TestProbeFailOpen:
    ...
    def test_config_dir_record_reads_only_its_own_scoped_item(
        ...
        rec = ProviderRecord(
            id="alt", name="alt", cli="claude", auth="managed", config_dir=alt
        )
    ...
    def test_managed_active_slot_occupant_is_probeable(
        ...
        rec = ProviderRecord(id="primary", name="primary", cli="claude", auth="managed")
    ...
    def test_managed_non_occupant_refuses_rather_than_borrowing(
        ...
        rec = ProviderRecord(id="other", name="other", cli="claude", auth="managed")
