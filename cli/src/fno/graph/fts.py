...
The FTS5 index lives in graph.db, kept in step by triggers (search.rs);
this module is a thin client for the keeper's ``search`` read op. An
unreachable keeper raises :class:`SearchUnavailableError`; callers degrade
to substring search.
"""
