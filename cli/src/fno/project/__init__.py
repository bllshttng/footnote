...
def receipt(project_id: str, state_dir: str) -> str:
    ...
    return (
        ...
        "  The only fno file left in the checkout is .fno/config.toml - committed\n"
        "  project config. Session state lives in the repo's space under\n"
        "  <state_dir>/spaces/ (keyed on the canonical repo root), not in the tree.\n"
