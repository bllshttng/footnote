...
RUST_CLIENT_VERBS = frozenset(
    {
        ...
        "review-coverage",
        # Pre-manifest <help> tag read (x-3567): the stop hooks' visitor-allowed
...
RUST_ONLY_VERB_HELP: dict[str, str] = {
    ...
    "distress-scan": "Read a transcript for a <help> tag and append a blocked row on a hit (x-3567): --transcript <path> --run <id> [--node <id>] [--harness <name>] [--cwd <dir>]. Best-effort, always exits 0.",
