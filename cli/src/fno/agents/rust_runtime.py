...
RUST_ONLY_VERB_HELP: dict[str, str] = {
    ...
    "spawn-gate": "The ONE spawn gate: JSON payload on stdin, the {status: admitted, gate/worker keys} or {status: refused, exit_code, receipt, event} answer on stdout; gate and probe modes; invoked by fno.agents.spawn_gate transport, not `fno agents` routing.",
