...
3. **Other agent runtimes.** If you have configured the loop's exec-shim drivers (`scripts/lib/driver-*.sh`) to use alternative LLM hosts, those runtimes have their own authentication. See driver-specific docs.
