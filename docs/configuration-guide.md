...
| `backlog.render_targets` | list[RenderTargetConfig] | `[]` | advanced | Auto-rendered public projections: every graph mutation re-renders each {path, project, projection=backlog\|roadmap} target through the leak gate. |
