...
| `locks/github-request-budget.json` (+ `.lock`) | `crates/fno-agents/src/gh_budget.rs` via the `fno-agents gh-budget` verb | rewritten per admitted request; stamps pruned past 60 s |
