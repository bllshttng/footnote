...
Six live duals below, plus two retirements recorded where they landed (the watchdog reap and retire lanes, 2026-09-04, and the node-dispatch launchers, 2026-09-12). The ask adapters, the claim classifier and the graph store are retired (2026-09-02), the review-freshness mirror followed (2026-09-03), and the ready-selection dual is retired (2026-09-08). The native graph reader remains the confirmed dual closest to a port, with seven port-owed duals named below.
