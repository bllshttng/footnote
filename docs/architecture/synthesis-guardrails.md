...
**Location:** `skills/execute/references/waves.md` Section 3a, `skills/execute/references/synthesis-checklist.md`
...
| File | Layer | Change |
|------|-------|--------|
| `skills/execute/references/waves.md` | 1 | Section 3a: pre-dispatch checklist |
| `skills/execute/references/synthesis-checklist.md` | 1 | Five-point checklist (new file) |
