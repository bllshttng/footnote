...
| The same choke point, Python leg (`fno.agents.registry`) | the bounded argv verb, overridden by the remover the spawn-axes ask carries | `session`, stamped by the shared builder |
