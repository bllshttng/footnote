...
- `src/client/tests/agent_launcher_tests.rs`: the width rule, the agent list, the key rule and the sheet paint, beside the existing editor and draft-retention units.
