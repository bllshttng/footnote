...
This graduated on 2026-09-10 (x-7783): the gate no longer decides on the one-minute load at all. Admission reads the fleet's attributed share of CPU capacity, an over sample holds and re-samples, and the load average survives only as the fifteen-minute backstop.
