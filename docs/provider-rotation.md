...
```bash
fno providers register readyrule --config-dir ~/.claude-alt
fno providers register makers    --config-dir ~/.claude
```
...
```
fno providers pick [--combo <name>] [--exclude <id>...] [--json] [--print-env]
```
