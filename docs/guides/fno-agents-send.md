...
- The target agent already registered via `fno agents spawn <name> --harness <p>` - see [fno-agents-spawn.md](fno-agents-spawn.md).
...
| Unknown agent | 16 | `unknown agent '<name>'; spawn it first: fno agents spawn <name> -H <provider>` |
