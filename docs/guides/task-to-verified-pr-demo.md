...
Show the recovery, not only the win. If the demo had unfinished runs, include them. A claim grows only as far as its receipts reach: a measured Footnote number or an imported observation with provenance. Comparative and adoption claims need actual imported observations or actual customers, and none exist yet.
