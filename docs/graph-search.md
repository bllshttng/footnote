...
A planner that asks which indexes a repo can answer starts at [code-index-providers.md](code-index-providers.md): the provider manifest, the three directories a user extends, and the blueprint step that asks by role.
