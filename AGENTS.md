...
- Distress: `<help reason="..." evidence="...">...</help>`. Cancel target: `printf 'author: you\nreason: why\n' > .fno/.target-cancelled` (a bare `touch` also works). King: `fno agents king cancel --scope <scope>`. Subprocess agents return `RESULT: BLOCKED`.
