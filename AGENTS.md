...
- graduates-to: the path-uniqueness lint that treats N reachable implementations of one operation as a CI failure, not a review catch; for the test variant, a lint treating an equivalence assertion over a payload-carrying enum as incomplete until the payload is compared too.
- added: 2026-07-23
