...
- `~/.fno/graph.db` - the backlog store, `graph.json` frozen. `fno backlog` only.
...
|------|---------|---------|-------|
| `paths.graph_json()` | `~/.fno/graph.db` + frozen `graph.json` (+ `.md` Kanban) | Feature dependency graph | backlog |
