...
Coordination & providers: [coordination](docs/architecture/coordination.md) · [provider rotation](docs/provider-rotation.md) · [provider command matrix](docs/provider-command-matrix.md) · [cross-model review](docs/architecture/cross-model-review.md) · [role-based routing](docs/architecture/role-based-model-routing.md)
