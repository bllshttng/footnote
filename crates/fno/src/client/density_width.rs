...
/// The width a density jumps to when picked as a preset (the density
...
/// The narrowest width at which a density still renders its structure.
...
/// The smallest terminal room ([`sideline_max_width`]) at which a
...
///
/// This is the pre-change per-density floor, and it is deliberately NOT
...
/// The largest sideline width this terminal allows: 60% of the columns,
...
pub(super) fn density_glyph(d: Density) -> char {
    // A fill ramp - rail, tree, table - reading as increasing density.
