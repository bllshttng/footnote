...
/// `git_crates_rev` (mirrors crates/fno-agents): dirty means the stamped
/// crates_rev does not fully describe this build, and an unrelated dirty file
/// elsewhere in the repo must not read as stale. Conservative: any git failure
/// reports `false` (a published/CI build is treated as clean).
fn git_dirty() -> bool {
