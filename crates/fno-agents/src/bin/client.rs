...
const ALL_CLIENT_ACTIONS: &[&str] = &[
    "--emit-schema", "adopt", "ask", "attach", "claim", "codex-loaded-threads",
    "detect", "digest", "drive", "drive-authority", "finalize", "grid", "help",
    "host", "kill-check", "list", "logs", "loop", "loop-check", "mail-inject",
    "needs", "ping", "probe-run", "promote", "reap", "reconcile", "report",
    "restart", "resume", "review-start", "rm", "spawn", "status", "stop",
    "subscribe", "trace", "verify-evidence", "version", "wait",
];
