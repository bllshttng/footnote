...
//! refuses any spawn a live crown rivals, aliases normalized through
//! `loop_king::crown_rivals`; the remaining gap is the Python lock-time
//! compare during the launch window.
//!
