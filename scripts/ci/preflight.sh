...
if HARNESS_MARKERS="$(PYTHONPATH="$PREFLIGHT_WT/cli/src" python3 -c \
   ...
   && [[ -n "$HARNESS_MARKERS" ]]; then
    ...
    HARNESS_MARKERS="CODEX_THREAD_ID CLAUDE_CODE_SESSION_ID CODEX_SESSION_ID GEMINI_SESSION_ID OPENCODE_SESSION_ID CLAUDE_SESSION_ID CLAUDECODE_SESSION_ID HERMES_SESSION_ID"
fi
