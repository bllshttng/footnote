...
if [[ -z "$ADDED" && -z "$REMOVED" ]]; then
  ...
  # the fno-agents binary, so the audit runs it directly; a lane with no
  # binary names the SKIP instead of failing, and provisioning the binary
  # there is what makes it run again.
