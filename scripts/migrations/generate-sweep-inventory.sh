...
MAPPINGS = [
    ...
    (r"\bbash (?:\./)?scripts/lib/infer-task-executor\.sh\b", "bash skills/do/scripts/resolve-executor.sh"),
    (r"\bbash (?:\./)?scripts/lib/parse-locked-executor\.sh\b", "bash skills/do/scripts/resolve-executor.sh"),
