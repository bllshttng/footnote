...
printf '%s\n' "{\"ended_at\":\"$now\",\"duration_seconds\":3600,\"samples\":60,\"floor\":200,\"min_remaining\":201,\"min_live_workers\":15,\"discretionary_probes\":60,\"coverage\":\"covered\",\"reviewed_count\":1,\"head_sha\":\"abc\",\"coverage_head_sha\":\"abc\",\"settled\":true}" > "$tmp/good/receipt.json"
printf '%s\n' "{\"ended_at\":\"$now\",\"duration_seconds\":3600,\"samples\":60,\"floor\":0,\"min_remaining\":1,\"min_live_workers\":15,\"discretionary_probes\":0,\"coverage\":\"unknown\",\"reviewed_count\":0,\"head_sha\":\"abc\",\"coverage_head_sha\":\"def\",\"settled\":true}" > "$tmp/bad/receipt.json"
