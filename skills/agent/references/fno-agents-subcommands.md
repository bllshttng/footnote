...
A subcommand with zero shell call sites is *not-yet-wired*, not dead: cutting requires proving no shell call site **and** no internal dispatch **and** no forward intent.
