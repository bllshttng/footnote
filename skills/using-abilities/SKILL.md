...
| `fno-agents loop run --driver target\|megawalk` | The unified Rust loop (step 5). Front doors: `scripts/run-target-loop.sh`, `/megawalk`. The old `fno loop` verb is removed. |
