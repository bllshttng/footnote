...
| 4. Review | Always (BEFORE PUSH) | `preship_review_plan` decides (see [phase-bodies.md](phase-bodies.md)): native review by default; `domain_phases.review`/`fno:review` sigma only when `config.review.reviewers` names `sigma` |
