...
The change touches a CLI flag, config key, schema, shipped file name, or a skill or agent name. These are one-way doors: renaming them later costs every user who already typed them.
