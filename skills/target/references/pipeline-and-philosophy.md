...
| Review | in-context fno lane | `/fno:review <size> --comment` on the local HEAD BEFORE the PR, in the invoking session; findings hold and post at PR open; sigma is retired | Always for code payloads | Opus (inline) |
