...
resolve node  →  fno do target start <node>   worktree off origin/main + claim + init prints the orienter
              ...
              →  review                      fno do target request-self-review --pr <n> on final HEAD
