...
Before dispatching, check the declared width against the route's provider budget (the four role subagents are the fan-out). This is a declaration check, not a cap the Task tool enforces:
