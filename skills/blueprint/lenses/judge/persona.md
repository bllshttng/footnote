...
Pass: the plan names who is hit and a present cost tied to a source the plan cites. The who is one of: the user, a crowned king, a worker session, a plugin user.
