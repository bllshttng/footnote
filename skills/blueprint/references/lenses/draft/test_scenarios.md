...
For each observable behavior change, give the plan a happy path, an error path, and one edge case. A behavior with only a happy path is a demo, not a feature.
