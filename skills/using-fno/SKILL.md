...
| `fno doctor intel` / `fno-agents intel` | The session-provenance fold: operator vs relay vs harness turns per session, node/PR join, relay facets. `/fno:intel` is the report skill over it. |
