...
| codex | Mail wake lands through the fno Codex RPC lane; no in-thread timer is documented. App automations start a new run. `internal/codex/docs/best-practices.md:176` | Externally owned daemon wake; no in-thread launcher verified. | `best-practices.md:176`; fno gap x-184a |
