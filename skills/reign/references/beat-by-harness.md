...
| Harness | Heartbeat |
|---|---|
| claude | Mail wake lands as a conversation turn; `/loop 55m` is the cheap heartbeat, armed by the crown itself. `internal/claude/docs/code/scheduled-tasks.md:33` |
